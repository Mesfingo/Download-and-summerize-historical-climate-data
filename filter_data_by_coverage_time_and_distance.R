 # The function takes as an input a  climate data generated by the function 'get_station_data' in this repositery 
 # in the form of a list, along with additional information and and outputs a 
 ...
 #  4. dat = the list containing climate data generated by the function 'var_data' 
